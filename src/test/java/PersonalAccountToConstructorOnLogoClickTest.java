...
public class PersonalAccountToConstructorOnLogoClickTest extends BaseTest {
    @Test
    @Description("Тест перехода из личного кабинета в конструктор, по клику на логотип Stellar Burgers")
    public void testPersonalToConstructorNavigationOnLogoClick() {
